...
namespace rog_map {
    ...
    public:
        ...
        void printPosInfo(const Vec3f &pos);
        ...
        double getCriticalDistance(const Vec3f &pos) const;
        
        double getCriticalDistance(const Vec3i &id_g) const;

        double getDistance2d(const Vec3f &pos) const;

        double getDistance2d(const Vec3i &id_g) const;
        ...
        //! xulong
        void getValueGrad(const Eigen::Vector3d& pos, double& dist, Eigen::Vector3d& grad) const;
        void getCriticalValueGrad(const Eigen::Vector3d& pos, double& dist, Eigen::Vector3d& grad) const;
        void getValueGrad2d(const Eigen::Vector3d& pos, double& dist, Eigen::Vector3d& grad) const;

        bool isLineFree2d(const Eigen::Vector2d &start, const Eigen::Vector2d &end, double threshold = 0.0) const;
        ...
        void getCriticalESDFPC2(const Vec3f &box_min_d,
                                const Vec3f &box_max_d,
                                const double &visualize_z,
                                sensor_msgs::PointCloud2 &pc2) ;
        
        void getFlatESDFPC2(const Vec3f &box_min_d,
                            const Vec3f &box_max_d,
                            sensor_msgs::PointCloud2 &pc2);


        void getESDFGradMarker(const Vec3f &box_min_d,
                                const Vec3f &box_max_d,
                                const double &visualize_z,
    ...
    private:
        ...
        std::vector<double> distance_buffer_2d; // maintains an additional 2d critical sdf map
        std::vector<double> distance_buffer_flat; // maintains an additional 2d sdf map
        ...
        void getSurroundDistance(Eigen::Vector3d pts[2][2][2], double dists[2][2][2]) const;
        ...
        void getSurroundPts(const Vec3f& pos, Vec3f pts[2][2][2], Vec3f & diff) const;
